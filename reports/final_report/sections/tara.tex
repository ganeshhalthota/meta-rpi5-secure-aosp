...
\begin{tabularx}{\textwidth}{p{0.8cm} p{1.5cm} X p{3.2cm} p{2.8cm}}
...
\label{tab:risk_boot}
\small
\begin{tabularx}{\textwidth}{p{0.8cm} >{\raggedright\arraybackslash}X p{1.5cm} p{1.5cm} c c}
\toprule
...
\begin{tabularx}{\textwidth}{p{0.8cm} p{4.5cm} X p{1.5cm}}
...
\label{tab:residual}
\small
\begin{tabularx}{\textwidth}{p{0.7cm} >{\raggedright\arraybackslash}X p{1.5cm} p{2.7cm} p{3.5cm}}
\toprule
